...
import { PrivacyPolicyComponent } from 'app/entities/privacy-policy/privacy-policy.component';
...
describe('Component Tests', () => {
  describe('PrivacyPolicy Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PrivacyPolicyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.privacyPolicies && comp.privacyPolicies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
