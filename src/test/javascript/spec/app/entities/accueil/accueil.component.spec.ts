  ...
  describe('Accueil Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AccueilComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.accueils && comp.accueils[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
