...
import { FooterSectionComponent } from 'app/entities/footer-section/footer-section.component';
...
describe('Component Tests', () => {
  describe('FooterSection Management Component', () => {
    let comp: FooterSectionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FooterSectionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.footerSections && comp.footerSections[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
