...
import { AProposComponent } from 'app/entities/a-propos/a-propos.component';
...
describe('Component Tests', () => {
  describe('APropos Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.aPropos && comp.aPropos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
