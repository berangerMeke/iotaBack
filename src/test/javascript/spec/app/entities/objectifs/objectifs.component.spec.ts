...
import { ObjectifsComponent } from 'app/entities/objectifs/objectifs.component';
...
describe('Component Tests', () => {
  describe('Objectifs Management Component', () => {
    let comp: ObjectifsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ObjectifsComponent, '')
        .compileComponents();
