...
import { AvantagesComponent } from 'app/entities/avantages/avantages.component';
...
describe('Component Tests', () => {
  describe('Avantages Management Component', () => {
    let comp: AvantagesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AvantagesComponent, '')
        .compileComponents();
