...
public class APropos implements Serializable {
    ...
    public APropos titreFr(String titreFr) {
    ...
    public APropos titreEn(String titreEn) {
    ...
    public APropos titreGer(String titreGer) {
    ...
    public APropos titreSw(String titreSw) {
    ...
    public APropos sousTitreFr(String sousTitreFr) {
    ...
    public APropos sousTitreEn(String sousTitreEn) {
    ...
    public APropos sousTitreGer(String sousTitreGer) {
    ...
    public APropos sousTitreSw(String sousTitreSw) {
    ...
    public APropos textParagraphe1Fr(String textParagraphe1Fr) {
    ...
    public APropos textParagraphe1En(String textParagraphe1En) {
    ...
    public APropos textParagraphe1Ger(String textParagraphe1Ger) {
    ...
    public APropos textParagraphe1Sw(String textParagraphe1Sw) {
    ...
    public APropos textParagraphe2Fr(String textParagraphe2Fr) {
    ...
    public APropos textParagraphe2En(String textParagraphe2En) {
    ...
    public APropos textParagraphe2Ger(String textParagraphe2Ger) {
    ...
    public APropos textParagraphe2Sw(String textParagraphe2Sw) {
    ...
    public APropos textParagraphe3Fr(String textParagraphe3Fr) {
    ...
    public APropos textParagraphe3En(String textParagraphe3En) {
    ...
    public APropos textParagraphe3Ger(String textParagraphe3Ger) {
    ...
    public APropos textParagraphe3Sw(String textParagraphe3Sw) {
    ...
    public APropos textParagraphe4Fr(String textParagraphe4Fr) {
    ...
    public APropos textParagraphe4En(String textParagraphe4En) {
    ...
    public APropos textParagraphe4Ger(String textParagraphe4Ger) {
    ...
    public APropos textParagraphe4Sw(String textParagraphe4Sw) {
    ...
    public APropos textParagraphe5Fr(String textParagraphe5Fr) {
    ...
    public APropos textParagraphe5En(String textParagraphe5En) {
    ...
    public APropos textParagraphe5Ger(String textParagraphe5Ger) {
    ...
    public APropos textParagraphe5Sw(String textParagraphe5Sw) {
    ...
    public APropos image(byte[] image) {
        this.image = image;
        return this;
    }
    ...
    public APropos imageContentType(String imageContentType) {
