...
public class Service implements Serializable {
    ...
    public Service titreFr(String titreFr) {
    ...
    public Service titreEn(String titreEn) {
    ...
    public Service titreGer(String titreGer) {
    ...
    public Service titreSw(String titreSw) {
    ...
    public Service sousTitreFr(String sousTitreFr) {
    ...
    public Service sousTitreEn(String sousTitreEn) {
    ...
    public Service sousTitreGer(String sousTitreGer) {
    ...
    public Service sousTitreSw(String sousTitreSw) {
    ...
    public Service textParagraphe1Fr(String textParagraphe1Fr) {
    ...
    public Service textParagraphe1En(String textParagraphe1En) {
    ...
    public Service textParagraphe1Ger(String textParagraphe1Ger) {
    ...
    public Service textParagraphe1Sw(String textParagraphe1Sw) {
    ...
    public Service textParagraphe2Fr(String textParagraphe2Fr) {
    ...
    public Service textParagraphe2En(String textParagraphe2En) {
    ...
    public Service textParagraphe2Ger(String textParagraphe2Ger) {
    ...
    public Service textParagraphe2Sw(String textParagraphe2Sw) {
    ...
    public Service textParagraphe3Fr(String textParagraphe3Fr) {
    ...
    public Service textParagraphe3En(String textParagraphe3En) {
    ...
    public Service textParagraphe3Ger(String textParagraphe3Ger) {
    ...
    public Service textParagraphe3Sw(String textParagraphe3Sw) {
    ...
    public Service textParagraphe4Fr(String textParagraphe4Fr) {
    ...
    public Service textParagraphe4En(String textParagraphe4En) {
    ...
    public Service textParagraphe4Ger(String textParagraphe4Ger) {
    ...
    public Service textParagraphe4Sw(String textParagraphe4Sw) {
    ...
    public Service textParagraphe5Fr(String textParagraphe5Fr) {
    ...
    public Service textParagraphe5En(String textParagraphe5En) {
    ...
    public Service textParagraphe5Ger(String textParagraphe5Ger) {
    ...
    public Service textParagraphe5Sw(String textParagraphe5Sw) {
